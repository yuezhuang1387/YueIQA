...
testpath = '/mnt/yue/YueIQA/data/IQAtrain.txt'
old_name_list = []
new_name_list = []
score_list = []
# 1、读取图片名称为中文的txt
with open(testpath,'r',encoding='utf-8') as f:
    for i, line in enumerate(f):
        ...
        new_name_list.append(str(i)+'.jpg')
...
root_read = '/mnt/msk/IQA/Data/Train_Data/IQA_Train_22_5_6_img'
root_write = '/mnt/yue/Turingdataset/IQA_Train_22_5_6_img_noChi'
